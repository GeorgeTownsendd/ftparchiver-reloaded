...
if __name__ == '__main__':
    ...
    unique_database_list = ['teams-weekly']#list(set(['nzl-od-34', 'u16-weekly', 'market-archive', 'u21-national-squads', 'teams-weekly', 'nzl-t20-33', 'sa-od-42', 'PGT', 'u21-national-squads']))
